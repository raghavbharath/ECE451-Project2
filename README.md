...
**_ECE 451 - Advanced Computer Architecture_**

**_Project 2_**

**_Group Members: Raghav Bharathan, Arnav Revankar_**
...
We used 2 CPU models:

TimingSimpleCPU, a non-pipelined model used to establish instruction mix and baseline behavior

MinorCPU, a 4-stage in-order pipelined model used to study throughput and latency effects
...
This project demonstrates how architectural decisions at both the CPU and cache level affect real workload performance. 
...
Our project provides practical insight into performance modeling using industry standard tools and highlights why architectural tradeoffs must be evaluated holistically rather than in isolation.

For statistical and technical explanations, check out the project report!
